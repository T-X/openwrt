...
#define RTL838X_NUM_PORTS 29
#define RTL839X_NUM_PORTS 53
#define RTL930X_NUM_PORTS 29
#define RTL931X_NUM_PORTS 57
#define RTL838X_MC_PMASK_ALL_PORTS (GENMASK(RTL838X_NUM_PORTS - 1, 0))
#define RTL839X_MC_PMASK_ALL_PORTS (GENMASK_ULL(RTL839X_NUM_PORTS - 1, 0))
#define RTL930X_MC_PMASK_ALL_PORTS (GENMASK(RTL930X_NUM_PORTS - 1, 0))
#define RTL931X_MC_PMASK_ALL_PORTS (GENMASK_ULL(RTL931X_NUM_PORTS - 1, 0))
